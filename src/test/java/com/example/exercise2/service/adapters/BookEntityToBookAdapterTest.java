...
public class BookEntityToBookAdapterTest {
  ...
  void convert_BookEntity_to_Book_test() {
    ...
    BookEntity bookEntity = new BookEntity(1l, "Science 1", "Mr. A");
    Book expectedBookObject = new Book(1l, "Science 1", "Mr. A");
  ...
  void convert_List_BookEntity_to_List_Book_test() {
    List<BookEntity> bookEntityList = Arrays.asList(
        new BookEntity(1l, "Science 1", "Mr. A"),
        new BookEntity(2l, "Science 2", "Mr. Z"),
        new BookEntity(3l, "Science 3", "Mr. G"),
        new BookEntity(4l, "Science 4", "Mr. D")
    );
